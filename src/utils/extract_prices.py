...
def main():
    ...
    use_default = (
        input(f"Use default output path ({output_dir}/{name_part}_prices.csv)? (y/n): ")
        .strip()
        .lower()
    )
    ...
    if success:
        ...
        show_sample = (
            input("Would you like to display a sample of the extracted data? (y/n): ")
            .strip()
            .lower()
        )
        if show_sample == "y":
        ...
        another = (
            input("\nWould you like to extract price data from another file? (y/n): ")
            .strip()
            .lower()
        )
        if another == "y":
